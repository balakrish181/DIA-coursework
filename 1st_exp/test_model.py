...
agent.model.load_state_dict(torch.load('1st_exp\dqn_model_reward1.pth'))
...
for episode in range(num_test_episodes):
    ...
    while step < MAX_STEPS_PER_EPISODE:
        ...
        #if done:
            #break
    print("Test Episode:", episode + 1, "Total Reward:", total_reward,'Score: ', score)
...
data = {'rewards': rewards, 'scores': scores}
df = pd.DataFrame(data)
df.to_csv('rewards_test_bigger.csv', index=False)
